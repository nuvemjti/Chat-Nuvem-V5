const messages = {
  tr: {
    translations: {
      ...
      initialConfig: {
        title: "İlk ayar",
        content1: "zionCRM 😊'a Hoşgeldiniz",
        content2:
          "Bunu kolaylaştırmak için * Hayatın, otomatik bir başlangıç ​​konfigürasyonu sağlıyoruz, böylece tüm ZionCRM * * İnanılmaz * özelliklerini birkaç dakika içinde test edebilirsiniz.",
        content3:
        ...
        content4:
          "Bağlı sayıda ilk mesajı alır almaz, ZionCRM eyleme geçecektir. 😎",
        content5:
