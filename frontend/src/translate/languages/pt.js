    ...
    translations: {
      ...
      dashboard: {
        ...
        monitoring: {
          ...
          predictedVolume: "Volume Previsto",
          metrics: {
            pending: "Pendentes",
            waiting: "Aguardando",
            resolved: "Resolvidos",
            responseTime: "T.M. Resposta",
            resolutionTime: "T.M. Resolução",
            throughput: "Produtividade"
          },
          alerts: {
            highPending: "Alto número de tickets pendentes",
            highResponseTime: "Tempo de resposta elevado",
            lowPerformance: "Performance abaixo do esperado"
          },
          attendantMetrics: {
            title: "Métricas por Atendente",
        ...
        metrics: {
          financials: {
            ...
            totalOpenTickets: "Valor Total em Aberto",
            averageTicketValue: "Ticket Médio",
          ...
          leads: {
            ...
            avgTimeToConversion: "Tempo Médio de Conversão",
            sourceEfficiency: "Eficiência por Fonte"
          },
          kpis: {
      ...
      showTicketLogModal: {
        ...
        options: {
          ...
          nps: "encaminhou a avaliação.", //Nome integrado ao catalogo de tradução. --> Igor
          autoClose: "| Fechado Automaticamente.", //Nome integrado ao catalogo de tradução. --> Igor
        },
      },
      whatsappModal: {
        title: {
      ...
      tickets: {
        ...
        buttons: {
		  ...
		  quickmessageflashMenu: "Menu de Mensagens",
        },
        closedTicket: {
      ...
      quickMessages: {
        ...
        toasts: {
          success: "Mensagem adicionada com sucesso!", //Ajuste na mensagem -> Igor
          deleted: "Mensagem removida com sucesso!", //Ajuste na mensagem -> Igor
        },
        dialog: {
