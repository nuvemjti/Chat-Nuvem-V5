...
import { MenuList, Grid, Popover, IconButton, makeStyles } from "@material-ui/core";
...
const MessageOptionsMenu = ({
  ...
  return (
    <>
      ...
      <Menu
        ...
        anchorOrigin={{
          vertical: anchorEl && window.innerHeight - anchorEl.getBoundingClientRect().bottom < 200 ? "top" : "bottom",
          horizontal: "right",
        }}
        transformOrigin={{
          vertical: anchorEl && window.innerHeight - anchorEl.getBoundingClientRect().bottom < 200 ? "bottom" : "top",
          horizontal: "right",
        }}
        open={menuOpen}
        onClose={handleClose}
      >
        ...
        <MenuItem onClick={openReactionsMenu}>
          <AddReactionIcon style={{ marginRight: 8 }} /> 
          {i18n.t("messageOptionsMenu.react")}
        </MenuItem>
        <MenuItem onClick={handleSetShowSelectCheckbox}>
        <ReplyAllIcon style={{ transform: "scaleX(-1)", marginRight: 8 }} />   
  ...
  anchorOrigin={{
    vertical: reactionAnchorEl?.getBoundingClientRect().bottom + 200 > window.innerHeight ? "bottom" : "top",
    horizontal: "center",
  }}
  transformOrigin={{
    vertical: reactionAnchorEl?.getBoundingClientRect().bottom + 200 > window.innerHeight ? "top" : "bottom",
    horizontal: "center",
  }}
  PaperProps={{
    style: { 
      ...
      maxWidth: "380px", 
      borderRadius: "50px",
      marginTop: reactionAnchorEl?.getBoundingClientRect().bottom + 200 > window.innerHeight ? -20 : -10
    }
  }}
>
...
<Popover
  ...
  anchorOrigin={{
    vertical: moreAnchorEl?.getBoundingClientRect().bottom + 200 > window.innerHeight ? "bottom" : "top",
    horizontal: "center",
  }}
  transformOrigin={{
    vertical: moreAnchorEl?.getBoundingClientRect().bottom + 200 > window.innerHeight ? "top" : "bottom",
    horizontal: "center",
  }}
  PaperProps={{
    style: { 
      ...
      maxWidth: "400px", 
      borderRadius: "6px",
      marginTop: moreAnchorEl?.getBoundingClientRect().bottom + 200 > window.innerHeight ? -20 : -10
    }
  }}
>
