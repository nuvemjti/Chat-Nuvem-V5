...
const useStyles = makeStyles((theme) => ({
  ...
  buttonUniversal: {
    ...
    padding: "10px 10px",  // Ajuste o padding para deixar o botão mais espaçado, se necessário
  },
  ...
  formControl: {
    minWidth: 120,
    borderRadius: "12px", // Adiciona borda arredondada
    "& .MuiOutlinedInput-root": {
      borderRadius: "12px", // Aplica a borda arredondada ao input dentro do FormControl
    },
  },
              ...
              <DialogActions>
                {!values.isCategory && !attachment && !quickemessage.mediaPath && (
                  <Button
                    ...
                    disabled={isSubmitting || (quickemessageId && values.visao && !values.geral && values.userId !== user.id)}
                    variant="outlined"
					className={classes.buttonUniversal}
                  >
