...
const WppOficialModal = ({ open, onClose, whatsAppId }) => {
  ...
  const [officialWppBusinessId, setOfficialWppBusinessId] = useState("");
  ...
  useEffect(() => {
    const fetchSession = async () => {
      ...
      try {
        ...
        setOfficialAccessToken(data.officialAccessToken);
        setOfficialVerifyToken(data.officialVerifyToken);
        setOfficialWppBusinessId(data.officialWppBusinessId);
        setOfficialPhoneNumberId(data.officialPhoneNumberId);
        setOfficial(true);
  ...
  const handleSaveWhatsApp = async (values) => {
    ...
    const whatsappData = {
      ...
      officialAccessToken: officialAccessToken ? officialAccessToken : null,
      officialVerifyToken: officialVerifyToken ? officialVerifyToken : null,
      officialWppBusinessId: officialWppBusinessId
  ...
  const sendRequestHelper = async () => {
    try {
      ...
      const { data: rawResult } = await axios({
        method: "post",
        url: `https://graph.facebook.com/v14.0/${officialWppBusinessId}/register`,
        data: JSON.stringify({
                  ...
                  <DialogContent dividers>
                    ...
                    <div>
                      ...
                      <Grid xs={12} md={12} xl={12} item>
                        <Field
                          as={TextField}
                          label={i18n.t("Token de acesso")}
                          fullWidth
                          name="officialAccessToken"
                          value={officialAccessToken}
                          onChange={(e) => {
                            setOfficialAccessToken(e.target.value);
                          }}
                          variant="outlined"
                          margin="dense"
                        />
                        <Field
                          as={TextField}
                          label={i18n.t("ID Whatsapp Business")}
                          fullWidth
                          name="officialWppBusinessId"
                          value={officialWppBusinessId}
                          onChange={(e) => {
                            setOfficialWppBusinessId(e.target.value);
                          }}
                          variant="outlined"
                          margin="dense"
                        />
                        ...
                        <Field
                          as={TextField}
                          label={i18n.t("ID Número Telefone")}
                          fullWidth
                          name="officialPhoneNumberId"
                          value={officialPhoneNumberId}
                          onChange={(e) => {
                            setOfficialPhoneNumberId(e.target.value);
                          }}
                          variant="outlined"
                          margin="dense"
                        />
...
export default React.memo(WppOficialModal);
