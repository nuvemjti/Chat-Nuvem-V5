...
const useStyles = makeStyles((theme) => ({
  ...
  messageLeft: {
    ...
    display: "block",
    position: "relative",
	textAlign: "left", // Alinha o texto internamente
	overflowWrap: "break-word", // Garante que palavras longas sejam quebradas
  ...
  textContentItem: {
    overflowWrap: "break-word", // Quebra o texto longo
  padding: "0px 80px 0px 0px", // Espaçamento (superior, direita, inferior, esquerda)
  fontSize: "14px", // Tamanho da fonte
  lineHeight: "20px", // Espaçamento entre linhas
  color: "inherit", // Herda a cor do balão
  wordBreak: "break-word", // Quebra palavras longas
  marginBottom: "16px", // Espaço abaixo do texto para o timestamp
  },
  ...
  fontSize: "11px",
  position: "absolute",
  bottom: "3px", // Ajuste fino para alinhar na borda inferior
  right: "5px", // Espaço da borda direita do balão
  color: "#999",
  zIndex: 1, // Garante que o timestamp fique visível
},
