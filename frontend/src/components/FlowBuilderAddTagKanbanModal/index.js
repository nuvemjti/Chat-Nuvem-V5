...
const FlowBuilderTagKanbanModal = ({ open, onSave, data, onUpdate, close }) => {
    ...
    <div className={classes.root}>
      ...
      >
        <DialogTitle id="form-dialog-title">
          {open === "create" ? `Adicionar uma tag kanban ao fluxo` : `Editar tag kanban`}
        </DialogTitle>
        <Stack>
          <DialogContent dividers>
            <Grid style={{ width: "100%", marginTop: 40 }} container>
              <Typography>Escolha uma tag kanban</Typography>
              <Select
...
export default FlowBuilderTagKanbanModal;