...
import wSocket from "../../assets/wsocket.png";
import WppOficialModal from "../../components/WppOficialModal";
...
const Connections = () => {
  ...
  const [selectOfficial, setSelectedOfficial] = useState(null);
  ...
  const handleOpenWhatsAppModal = ({ oficial = false }) => {
    setSelectedWhatsApp(null);
  ...
  const handleEditOfficial = (whatsApp) => {
    setSelectedOfficial(whatsApp);
    setOfficialModalOpen(true);
  };
  ...
  const renderActionButtons = (whatsApp) => {
    return (
      <>
        {whatsApp.status === "qrcode" && whatsApp.channel !== "official" && (
          <Can
            role={
        ...
        {whatsApp.status === "OPENING" && whatsApp.channel !== "official" && (
  ...
  const renderStatusToolTips = (whatsApp) => {
    return (
      <div className={classes.customTableCell}>
        ...
        {whatsApp.status === "CONNECTED" && whatsApp.channel !== "official" && (
          <CustomToolTip title={i18n.t("connections.toolTips.connected.title")}>
            <SignalCellular4Bar style={{ color: green[500] }} />
          </CustomToolTip>
        )}
                          ...
                          <Menu {...bindMenu(popupState)}>
                            ...
                            <MenuItem
                              ...
                              onClick={() => {
                                ...
                                handleOpenWhatsAppModal({ oficial: false });
                                popupState.close();
                              }}
                            >
                              <img
                                ...
                                <IconButton
                                  ...
                                  onClick={() => {
                                    if (whatsApp.channel === "official") {
                                      return handleEditOfficial(whatsApp);
                                    }
                                    return handleEditWhatsApp(whatsApp);
                                  }}
                                >
                                  <Edit />
                                </IconButton>
