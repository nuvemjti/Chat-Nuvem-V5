  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div style={{ color: "#333", fontSize: "16px", fontWeight: "bold" }}>Áudio</div>
      </div>
      <div style={{ color: "#333", fontSize: "12px" }}>
        <div style={{ position: "absolute", right: "50px", top: "12px", color: "#333" }}>
          {data.record && data.record ? (
            <div>Gravado na hora</div>
          ) : (
            <div>Áudio enviado</div>
          )}
        </div>
        <audio controls="controls" style={{ marginTop: "5px" }}>
