      ...
      {user.profile === "user" && user.showDashboard === "disabled" ? (
        ...
        >
          <Container maxWidth="xl">
            ...
            {/* Distribuição do funil de campanhas */}
            <Card sx={{ mt: 2 }}>
              <CardContent>
                <Typography variant="h6" gutterBottom>Funil de Campanhas</Typography>
                <Grid2 container spacing={2}>
                  {/* Cards de métricas à esquerda */}
                  <Grid2 xs={12} md={3}>
                    <Stack spacing={2}>
                      <Card
                        sx={{
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.investimento?.toLocaleString('pt-BR', { 
                                style: 'currency', 
                                currency: 'BRL' 
                              }) || 'R$ 0,00'}
                            </Typography>
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.faturamento?.toLocaleString('pt-BR', { 
                                style: 'currency', 
                                currency: 'BRL' 
                              }) || 'R$ 0,00'}
                            </Typography>
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.roas?.toFixed(2) || '0,00'}
                            </Typography>
                          </Stack>
                        </Stack>
                      </Card>
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.taxaConversao?.toFixed(2) || '0,00'}%
                            </Typography>
                          </Stack>
                        </Stack>
                      </Card>
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.ticketMedio?.toLocaleString('pt-BR', { 
                                style: 'currency', 
                                currency: 'BRL' 
                              }) || 'R$ 0,00'}
                            </Typography>
                  ...
                  <Grid2 xs={12} md={6}>
                    <ResponsiveContainer width="100%" height={350}>
                      <FunnelChart>
                        ...
                        <Funnel
                          dataKey="value"
                          data={campaignFunnelData.stages}
                          labelLine={false}
                        >
                          {campaignFunnelData.stages.map((entry, index) => (
                            <Cell 
                              key={`cell-${index}`}
                              fill={entry.color}
                            />
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.cpl?.toLocaleString('pt-BR', { 
                                style: 'currency', 
                                currency: 'BRL' 
                              }) || 'R$ 0,00'}
                            </Typography>
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.custoMql?.toLocaleString('pt-BR', { 
                                style: 'currency', 
                                currency: 'BRL' 
                              }) || 'R$ 0,00'}
                            </Typography>
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.custoReuniao?.toLocaleString('pt-BR', { 
                                style: 'currency', 
                                currency: 'BRL' 
                              }) || 'R$ 0,00'}
                            </Typography>
                      ...
                      >
                        <Stack direction="row" alignItems="center" spacing={2}>
                          ...
                          <Stack sx={{ flex: 1 }}>
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 600 }}>
                              {campaignFunnelData.cpa?.toLocaleString('pt-BR', { 
                                style: 'currency', 
                                currency: 'BRL' 
                              }) || 'R$ 0,00'}
                            </Typography>
