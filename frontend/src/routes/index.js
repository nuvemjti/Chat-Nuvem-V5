...
import ExtractionPage from "../pages/Extracao";
import TagsKanban from "../pages/TagsKanban";
import { Plantao } from '../pages/Plantao';
import { saveCurrentRoute } from "../utils/routePersistence";
import { FlowVariablesProvider } from "../context/FlowVariables";
          ...
          <Switch>
            ...
            <WhatsAppsProvider>
              <LoggedInLayout>
                ...
                <Route exact path="/extractor" component={ExtractionPage} isPrivate />
